...
$to = "contato@ariadneokuyama.com.br";														// To Address
$from = "contato@ariadneokuyama.com.br";													// From Address
$fromName = "Ariadne Okuyama";											// From Name
...
$template = "Olá!<br><br>Você recebeu uma nova inscrição <br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>Have a nice day.";											// Mail Template
$autorespondSubjectPrefix = "Re:";			// Autorespond Form Subject Prefix
$autorespondSubject = "Obrigada por se inscrever!";						// Autorespond Custom Subject
$autorespondTemplate = "Olá {name},<br><br>Obrigada por ter se inscrito!<br>A partir de agora você fará parte do nosso grupo no Telegram e receberá conteúdo exclusivo meu.<br><br>Estes são os dados que você nos passou:<br>{formdata}<br><br>---<br>Obrigada mais uma vez e até o nosso próximo contato!";					// Autorespond Template
